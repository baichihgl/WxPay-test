...
class WxPayConfigInterface {
    ...
    private $AppId,$MerchantId,$Key,$NotifyUrl,$AppSecret;
    ...
    function SetSignType($SignType = "HMAC-SHA256"){
...
//        $sslCertPath = '../history/apiclient_cert.pem';
//        $sslKeyPath  = '../history/apiclient_key.pem';
        $sslCertPath = getcwd().'/history/apiclient_cert.pem';
        $sslKeyPath  = getcwd().'/history/apiclient_key.pem';
    }
}
