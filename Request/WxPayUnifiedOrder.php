...
class WxPayUnifiedOrder extends WxPayDataBase
{
     ...
     * Author: Sorghum
     * Date: 2019/9/11
     * Description:厉害   企业付款的商户号变量命名没下划线
     * @param $value
     */
     ...
     * Author: Sorghum
     * Date: 2019/9/10
     * Description:企业付款接口   商户订单号 需保持唯一性
    (只能是字母或者数字，不能包含有其他字符)
     */
     ...
     * Author: Sorghum
     * Date: 2019/9/10
     * Description: 企业付款接口  amount 企业付款金额，单位为分
     * @return bool
     */
     ...
     * Author: Sorghum
     * Date: 2019/9/10
     * Description:企业付款备注，必填。注意：备注中的敏感词会被转成字符*
     * @param $value
     */
