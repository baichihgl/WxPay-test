...
class WxPayDataBase
{
    ...
    public function SetSignOutOfSignType($config)
    {
        $sign = $this->MakeSignOutOfSignType($config,'MD5');
        $this->values['sign'] = $sign;
        return $sign;
    }
     ...
     * Author: Sorghum
     * Date: 2019/9/11
     * Description:签名方式 不加入签名
     * @param $config
     * @param $signType
     * @return string
     * @throws WxPayException
     */
    public function MakeSignOutOfSignType($config,$signType)
    {
